        ...
        this.countKeywords = (keywords, comment) => {
            ...
            tokenizer.tokenize(comment.content).forEach((word) => {
                ...
                commentKeywords.forEach((keywordUsage) => {
                    ...
                    let bracketWordsCount = 0
                    keywordUsage.keywords.forEach((wordUsage) => {

                        if(wordUsage.word.split('/bw').length > 1) {
                            bracketWordsCount++
                            let wordRegex = wordUsage.word.split('/bw')[0]
                            wordRegex = '^'+wordRegex+'$'
                    ...
                    fulfill = fulfill / (keywordUsage.keywords.length - bracketWordsCount)
