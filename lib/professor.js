...
class Professor {
    ...
    constructor(firebase) {
        ...
        this.countKeywords = (keywords, comment) => {
            ...
            let commentKeywords = { keywords: [], totalKeywordUsed: 0 }
            ...
            keywords.forEach((keyword) => {
                ...
                if(keywordUsage.fulfill === 1) {
                    commentKeywords.totalKeywordUsed++
                }
        ...
        comments.forEach((comment) => {
            ...
            if(commentStudentKey !== null && typeof comment.inReplyTo === 'undefined') {
                ...
                if(typeof students[commentStudentKey].posts[post.id] === 'undefined') {
                    students[commentStudentKey].posts[post.id] = { analisou: 0, discutiu: 0, totalOfKeywordsUsed: 0, observou: 0, comments: {}, numOfComments: 0, numOfReferences: 0, numOfReceivedAnswers: 0, numOfWrittenAnswers: 0 }
                }
                ...
                let analysis = this.countKeywords(post.keywords, comment)
                students[commentStudentKey].posts[post.id].comments[comment.id].keywordUsage = analysis
                students[commentStudentKey].posts[post.id].totalOfKeywordsUsed += analysis.totalKeywordUsed
            ...
            comment.replies.forEach((reply) => {
                ...
                if(replyStudentKey !== null) {
                    ...
                    if(typeof students[replyStudentKey].posts[post.id] === 'undefined') {
                        students[replyStudentKey].posts[post.id] = { analisou: 0, discutiu: 0, totalOfKeywordsUsed: 0, observou: 0, comments: {}, numOfComments: 0, numOfReferences: 0, numOfReceivedAnswers: 0, numOfWrittenAnswers: 0 }
                    }
                    ...
                    let replyAnalysis = this.countKeywords(post.keywords, reply)
                    students[replyStudentKey].posts[post.id].comments[reply.id].keywordUsage = replyAnalysis
                    students[replyStudentKey].posts[post.id].totalOfKeywordsUsed += replyAnalysis.totalKeywordUsed
